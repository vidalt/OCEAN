        ...
        super().__init__(
            ...
            features=[
                Feature(
                    ...
                    levels=(10000 - 1, 1000000 + 1),
                ),
                Feature(ftype=Feature.Type.CONTINUOUS, levels=(20, 80)),
                Feature(
                    ftype=Feature.Type.CONTINUOUS,
                    levels=(-165580 - 1, 964511 + 1),
                ),
                Feature(
                    ftype=Feature.Type.CONTINUOUS,
                    levels=(-69777 - 1, 983931 + 1),
                ),
                Feature(
                    ftype=Feature.Type.CONTINUOUS,
                    levels=(-157264 - 1, 1664089 + 1),
                ),
                Feature(
                    ftype=Feature.Type.CONTINUOUS,
                    levels=(-170000 - 1, 891586 + 1),
                ),
                Feature(
                    ftype=Feature.Type.CONTINUOUS,
                    levels=(-81334 - 1, 927171 + 1),
                ),
                Feature(
                    ftype=Feature.Type.CONTINUOUS,
                    levels=(-339603 - 1, 961664 + 1),
                ),
                Feature(
                    ftype=Feature.Type.CONTINUOUS,
                    levels=(0 - 1, 873552 + 1),
