...
class Ui_Iteration(object):
    ...
    def retranslateUi(self, Iteration):
        ...
        self.labelSelectFeaturesToPlot.setText(_translate(
            "Iteration", "Select Features To Plot: select the desired features using the multiselection combobox below"))
        self.labelCanvasTitle.setText(_translate(
            "Iteration", "Drag the dots to change the point values: click on the dot over the axis that want to change and then pull it up or down"))
        ...
        self.labelFeatureDistribution.setText(_translate(
            "Iteration", "Feature Distribution: shows the clicked feature distribution"))
        self.labelNextInfo.setText(_translate(
            "Iteration", "The button \"Next\" instantiates a new scenario, and the button \"Finish\" instantiates the \"FinalScenario\""))
