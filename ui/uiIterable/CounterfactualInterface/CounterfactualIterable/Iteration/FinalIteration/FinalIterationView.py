...
class FinalIterationView(QWidget, Ui_FinalIteration):
    ...
    def clearView(self):
        ...
        self.labelCounterfactualClass.setText(self.__counterfactualScenarioName+' Class:')
    ...
    def showOriginalClass(self, classValue):
        ...
        self.labelOriginalClass.setText(self.__originalScenarioName+' Class: '+str(classValue))

    # this function is used to update the counterfactual class component
    def showCounterfactualClass(self, classValue):
        assert classValue is not None

        self.labelCounterfactualClass.setText(self.__counterfactualScenarioName+' Class: '+str(classValue))
    ...
    def showCounterfactualComparison(self, counterfactualComparison):
        ...
        self.__clearTableWidgetCounterfactualComparison()
        self.tableWidgetCounterfactualComparison.setHorizontalHeaderLabels(['Feature', self.__originalScenarioName, self.__counterfactualScenarioName])
