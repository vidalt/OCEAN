...
def test_CIS3RV_setContent_wrong_type_featureName_parameter(featureName):
    with pytest.raises(AssertionError):
        ...
        counterfactualInterfaceSlider3RangesView.setContent(featureName, 0, 1, 0.5, 1)

def test_CIS3RV_setContent_none_min_parameter():
    with pytest.raises(AssertionError):
        app = QtWidgets.QApplication(sys.argv)
        counterfactualInterfaceSlider3RangesView = StaticObjects.staticCounterfactualInterfaceSlider3RangesView()
        counterfactualInterfaceSlider3RangesView.setContent('featureName', None, 1, 0.5, 1)

def test_CIS3RV_setContent_none_max_parameter():
    with pytest.raises(AssertionError):
        app = QtWidgets.QApplication(sys.argv)
        counterfactualInterfaceSlider3RangesView = StaticObjects.staticCounterfactualInterfaceSlider3RangesView()
        counterfactualInterfaceSlider3RangesView.setContent('featureName', 0, None, 0.5, 1)

def test_CIS3RV_setContent_none_value_parameter():
    with pytest.raises(AssertionError):
        app = QtWidgets.QApplication(sys.argv)
        counterfactualInterfaceSlider3RangesView = StaticObjects.staticCounterfactualInterfaceSlider3RangesView()
        counterfactualInterfaceSlider3RangesView.setContent('featureName', 0, 1, None, 1)

def test_CIS3RV_setContent_none_decimalPlaces_parameter():
    with pytest.raises(AssertionError):
        app = QtWidgets.QApplication(sys.argv)
        counterfactualInterfaceSlider3RangesView = StaticObjects.staticCounterfactualInterfaceSlider3RangesView()
        counterfactualInterfaceSlider3RangesView.setContent('featureName', 0, 1, 0.5, None)
