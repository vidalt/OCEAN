...
# Form implementation generated from reading ui file 'c:\Users\Moises\Documents\GitHub\interfaceCounterfactual\INF2102\CounterfactualInterface\Slider3Ranges\Slider3Ranges.ui'
#
...
class Ui_Slider3Ranges(object):
    def setupUi(self, Slider3Ranges):
        Slider3Ranges.setObjectName("Slider3Ranges")
        Slider3Ranges.resize(500, 100)
        Slider3Ranges.setMinimumSize(QtCore.QSize(500, 100))
        Slider3Ranges.setMaximumSize(QtCore.QSize(500, 16777215))
        self.gridLayout = QtWidgets.QGridLayout(Slider3Ranges)
        self.gridLayout.setHorizontalSpacing(6)
        self.gridLayout.setObjectName("gridLayout")
        self.labelFeatureName = QtWidgets.QLabel(Slider3Ranges)
...
"}")
        ...
        self.checkBoxActionability = QtWidgets.QCheckBox(Slider3Ranges)
        ...
        self.doubleSpinBoxMinimum = QtWidgets.QDoubleSpinBox(Slider3Ranges)
        ...
        self.gridLayout.addWidget(self.doubleSpinBoxMinimum, 1, 0, 1, 1)
        self.widget = QtWidgets.QWidget(Slider3Ranges)
...
"}")
        ...
        self.doubleSpinBoxMaximum = QtWidgets.QDoubleSpinBox(Slider3Ranges)
        ...
        self.gridLayout.addWidget(self.doubleSpinBoxMaximum, 1, 3, 1, 1)
        self.labelAdjustPosition1 = QtWidgets.QLabel(Slider3Ranges)
...
"}")
        ...
        self.gridLayout.addWidget(self.labelAdjustPosition1, 2, 0, 1, 1)
        self.labelAdjustPosition2 = QtWidgets.QLabel(Slider3Ranges)
        self.labelAdjustPosition2.setMinimumSize(QtCore.QSize(0, 25))
        self.labelAdjustPosition2.setStyleSheet("QLabel {\n"
"    font-weight: bold;\n"
"}")
        self.labelAdjustPosition2.setText("")
        self.labelAdjustPosition2.setObjectName("labelAdjustPosition2")
        self.gridLayout.addWidget(self.labelAdjustPosition2, 2, 3, 1, 1)

        self.retranslateUi(Slider3Ranges)
        QtCore.QMetaObject.connectSlotsByName(Slider3Ranges)

    def retranslateUi(self, Slider3Ranges):
        _translate = QtCore.QCoreApplication.translate
        Slider3Ranges.setWindowTitle(_translate("Slider3Ranges", "Form"))
        self.checkBoxActionability.setText(_translate("Slider3Ranges", "actionable"))
