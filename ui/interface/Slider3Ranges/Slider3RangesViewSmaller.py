...
class Slider3RangesViewSmaller(QWidget, Ui_Slider3RangesSmaller):
    ...
    def setContent(self, featureName, minValue,
                   maxValue, value, decimalPlaces):
        ...
        self.labelRangeMinimum.outdatedGraph.connect(
            lambda: self.outdatedGraph.emit())
        ...
        self.labelRangeValue.outdatedGraph.connect(
            lambda: self.outdatedGraph.emit())
        ...
        self.labelRangeMaximum.initializeRange(
            ...
            Slider3RangesEnums.Space.MIN_MAX.value)
        self.labelRangeMaximum.outdatedGraph.connect(
            lambda: self.outdatedGraph.emit())
