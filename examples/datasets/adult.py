...
def load_adult(
    *,
    file: Path = Path(__file__).parent / "data" / "Adult_processedMACE.csv",
    target: str = "Class",
    ...
    features = [
        ...
        Feature(ftype=Feature.Type.CONTINUOUS, levels=(0 - 1, 99999 + 1)),
        Feature(ftype=Feature.Type.CONTINUOUS, levels=(0 - 1, 4356 + 1)),
